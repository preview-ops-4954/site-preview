...
<title>Agent login - ${esc(config.business.name)}</title><link rel="stylesheet" href="/static/styles.css?v=20260912h">
<link rel="icon" type="image/svg+xml" href="/static/favicon.svg"></head>
...
function signup(state = {}, values = {}, next = '') {
  ...
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">
<title>Create account - Agent portal - ${esc(config.business.name)}</title><link rel="stylesheet" href="/static/styles.css?v=20260912h">
<link rel="icon" type="image/svg+xml" href="/static/favicon.svg"></head>
<body><header class="auth-head">${brand('/', 'Media')}</header>
<main class="auth-main"><div class="auth-card">
...
<section class="section">
  ...
  <div class="portal-lead"><p class="muted">Every shoot, gallery, download, and property website for your listings.</p><a class="btn" href="/book">Book another shoot</a></div>
...
function deliveryLocked(order, fileCount) {
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">
<title>Delivery locked - ${esc(config.business.name)}</title><link rel="stylesheet" href="/static/styles.css?v=20260912h">
<link rel="icon" type="image/svg+xml" href="/static/favicon.svg"></head>
...
function siteUnavailable() {
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">
<title>Property website - ${esc(config.business.name)}</title><link rel="stylesheet" href="/static/styles.css?v=20260912h">
<link rel="icon" type="image/svg+xml" href="/static/favicon.svg"></head>
